...
/**
 * A dialog with a label and text area with OK/Cancel buttons.
 */
class TextAreaDialog extends Dialog {
	...
	public TextAreaDialog(Shell parent, String labelText, boolean edit) {
	...
	public String open() {
		...
		final Text textArea = new Text(formComposite, SWT.BORDER | SWT.WRAP | SWT.MULTI | SWT.V_SCROLL);
